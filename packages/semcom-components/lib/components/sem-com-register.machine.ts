...
import { formMachine, FormActors, FormContext, FormValidatorResult } from '@netwerk-digitaal-erfgoed/solid-crs-components';
...
SemComRegisterEvent> = {
  ...
  states: {
    ...
    [SemComRegisterStates.UPLOAD_COMPONENT_FORM]: {
      invoke: {
        id: FormActors.FORM_MACHINE,
        src: formMachine<UploadFormContext> ((context) => validateUploadForm(context)),
        data: {
